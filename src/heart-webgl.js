...
function loadModel(callback) {
  loader.load(
    ...
    function (gltf) {
      const heartSkeleton = gltf.scene;
...
loadModel((geometryTest) => {
  // console.log(geometryTest);
  const heartGeometry = geometryTest.children[0].geometry;
  ...
  function renderIntersects() {
    ...
    const intersects = raycaster.intersectObjects([geometryTest.children[0]]);
